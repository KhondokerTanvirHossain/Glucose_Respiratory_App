...
public class ListActivity extends AppCompatActivity {
    ...
    private String url = "http://192.168.43.50/healthCare4/showHeart.php";
    Context context;
            ...
            if (jsonObject == null)
                ...
                try {
                    ...
                    for (int i = 0; i < jsonArray.length(); i++) {
                        ...
                        options.add(new Glucose(object.getString("dt"),
                                object.getString("ts"),
                                object.getString("heart")));
                    }
                    ListView listView = (ListView) findViewById(R.id.list);
                    AdapterActivity2 adapterActivity = new AdapterActivity2(context, R.id.list, options);
